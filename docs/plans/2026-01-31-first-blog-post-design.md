# First Blog Post Design

**Goal:** Plan the first blog post for the billiemuk personal site - a technical overview of how the site was built.

## Summary

A developer-focused post explaining the tech stack, build process, workflow, and results of building a simple, fast static blog. Written in a direct, matter-of-fact style with concrete examples and external links.

## Audience

Developers. Technical but concise. No need to explain basics.
...
**Pleasant workflow.** I should be able to draft a post, see it live with hot reload, and deploy with a git push. No multi-step build processes or deployment scripts.

**Good defaults.** SEO files (sitemap, robots.txt), RSS feed, and responsive design should just work without me thinking about them.
...
- Mix code blocks, blockquotes, lists, and prose
- Keep paragraphs short (2-3 sentences)
- Link to all external tools and libraries
- Include concrete metrics (Lighthouse scores, image sizes, quality settings)
- Avoid em dashes, ChatGPT-isms, overselling
...
- Superpowers: https://github.com/superpowers-marketplace/superpowers
- Codex: https://github.com/cognition-labs/codex
